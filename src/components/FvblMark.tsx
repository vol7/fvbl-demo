...
/**
 * PLACEHOLDER CONTENT. This artwork is a stand-in supplied for the demo and CANNOT
 * be commercially distributed as-is. Replace it with the licensed FVBL mark before
 * anything built from this repo ships beyond the demo.
 *
 * The FVBL emblem: a shield with a four-pointed star at its heart and four leaves
 * cut around it. Drawn once here; the favicon in `public/favicon.svg` is the same
 * path and gradient, kept in sync by hand.
 *
      ...
      {tone === "gradient" && (
        <defs>
          <linearGradient id={gradientId} x1="0" y1="0" x2="1" y2="1">
            <stop offset="0" stopColor="#082F55" />
            <stop offset="0.55" stopColor="#1F6FB2" />
            <stop offset="1" stopColor="#6DBBF0" />
          </linearGradient>
        </defs>
      )}
      <path
